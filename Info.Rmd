...
- Fit Classification NN model
- Productionize model for the new coming data
- Record more new data once the model predicts market types with a very high confidence
- In MQL side:
    - record market type once new order is placed
    - use reinforcement learning to define a policy for each market type
- Weekly update the model with new data
